...
public partial class Administrator_AddProduct : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { Response.Redirect("~/Administrator/AdminLogin.aspx?ADD=~/Administrator/AddFeaturedProducts.aspx"); }
        ...
        if (!IsPostBack)
        {
            ...
            string Querys = "SELECT Product_Id FROM FeaturedProducts ORDER BY Id ";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (uploadImage.FileName != "")
        {
            ...
            z.InsertFileToFolder(uploadImage, "~/Images/FeaturedProducts");
            z.InsertFileToFolder(uploadImage, "~/Images/FeaturedProducts/Large");

            TextBox txt = new TextBox();
            txt.Text = "~/Images/FeaturedProducts/" + uploadImage.FileName;

            TextBox txtDot = new TextBox();
            txtDot.Text = "./Images/FeaturedProducts/" + uploadImage.FileName;
            ...
            string InsertData = "INSERT INTO FeaturedProducts(Location,Location_Dot,Name,Price,Product_Id,Description,Purity,Weight,MakingCharge,Discount) VALUES(@Param1,@Param2,@Param3,@Param4,@Param5,@Param6,@Param7,@Param8,@Param9,@Param10);";
        ...
        if (statusData > 0)
        {
            ...
            int statusLog = z.QueryExecute(InsertLog, System.DateTime.Now.ToString(), "Featured Product Inserted");
        }
