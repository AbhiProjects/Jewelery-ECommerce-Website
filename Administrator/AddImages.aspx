<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Admin.master" AutoEventWireup="true" CodeFile="AddImages.aspx.cs" Inherits="Administrator_AddImages" %>
    ...
    <table class="style1" 
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td class="style5">
                <asp:Label ID="lblName" runat="server" Text="Page Section" Font-Names="Calibri" 
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td class="style5">
                <asp:Label ID="lblupload" runat="server" Text="Image Location" 
                    Font-Names="Calibri" Font-Size="Large"></asp:Label>
            </td>
            <td class="style4">
                <asp:FileUpload ID="uploadImage" runat="server" Width="240px" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td class="style4">
                <asp:Button ID="btnUpload" runat="server" onclick="btnUpload_Click" 
                    Text="Upload" ValidationGroup="DataEntry" Font-Names="Calibri" 
