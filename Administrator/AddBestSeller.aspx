<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Admin.master" AutoEventWireup="true" CodeFile="AddBestSeller.aspx.cs" Inherits="Administrator_AddProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="c1" Runat="Server">
    <table class="style1" 
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDescription" runat="server" Height="78px" Width="252px" 
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtWeight" runat="server" Height="23px" Width="145px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPurity" runat="server" Height="23px" Width="145px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtMakingCharge" runat="server" Height="23px" Width="145px"></asp:TextBox>
            </td>
            <td>
