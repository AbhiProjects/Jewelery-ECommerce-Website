...
public partial class Description : System.Web.UI.Page
{
    ...
    void getDescHeader()
    {
        ...
        string Query = "SELECT * FROM BestSeller WHERE Product_Id='" + ID + "'";
        dset = z.FillDataset(Query);

        string AllQuery = "SELECT * FROM BestSeller WHERE Product_Id='" + ID + "'"; ;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            temp = "Login.aspx?ADD=BestSellerDescription.aspx?ID=" + ID;
        ...
        else
        {
            ...
            temp = "BestSellerInvoice.aspx?ID=" + ID;
            Response.Redirect(temp);
        }
    ...
    void getZoomImage()
    {
        ...
        string AllQuery = "SELECT Location_Dot FROM BestSeller WHERE Product_Id='" + ID + "'";
        DataTable dtAll = new DataTable();
        dtAll = z.FillDataTable(AllQuery);

        string temp = dtAll.Rows[0][0].ToString().Remove(0, 20);
        string img = "./Images/BestSeller/" + temp;
        string imgzoom = "./Images/BestSeller/Large/" + temp;
