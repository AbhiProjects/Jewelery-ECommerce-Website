...
{
    string BindQuery = "Select * FROM Promotions";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { Response.Redirect("Login.aspx?ADD=PromotionDisplay.aspx"); }
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    Grid.Rows[0].Cells[0].Text = "Currentlty There Are No Promotional Offers Available";
                }
