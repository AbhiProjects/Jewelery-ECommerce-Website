...
<br /><br />
	...
	<section id="content">
			...
			<h1>Login Form</h1>
			<div>
            <asp:TextBox ID="username" Text="Username@max.com" runat="server"></asp:TextBox>
                ...
                <br />
                <asp:RegularExpressionValidator ID="regularUserName" runat="server" 
                    ControlToValidate="username" ErrorMessage="Please Enter A Valid User Name" 
                    Font-Bold="True" ForeColor="Red" 
                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                <%--<input type="text" placeholder="Username" required="" id="username" />--%>
			</div>
			<div>
            <asp:TextBox ID="password" Text="password" runat="server" TextMode="Password"></asp:TextBox>
			...
			<div>
            <asp:Button value="Log in" ID="Submit" runat="server" onclick="Submit_Click" Text="Login" />
                <%--<input type="submit" value="Log in" />--%>
				<a href="ForgotPassword.aspx">Can't Access Your Account</a></div>
		    </form>
            <!-- form -->
		<!-- button -->
	</section><!-- content -->
