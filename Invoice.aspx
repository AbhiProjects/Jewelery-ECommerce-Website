<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEndMaster.master" AutoEventWireup="true" CodeFile="Invoice.aspx.cs" Inherits="Invoice" %>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style3">
                Category</td>
            <td colspan="2">
                <asp:Label ID="LblCategory" runat="server" Font-Bold="True" Font-Size="Medium"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
            <td>
